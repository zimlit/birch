...
BirchWindow *birchWindowNew(unsigned int width, unsigned int height,
                            const char *title);
...
void birchWindowSetMouseMovedCallback(BirchWindow *window,
                                      void (*mouseMovedCallback)(int x,
                                                                 int y));

void birchWindowSetResizeCallback(BirchWindow *window,
                                  void (*resizeCallback)(int width,
                                                         int height));

void birchWindowSetKeyPressedCallback(BirchWindow *window,
                                      void (*keyPressedCallback)(int key));

void birchWindowSetKeyReleasedCallback(BirchWindow *window,
                                       void (*keyReleasedCallback)(int key));
